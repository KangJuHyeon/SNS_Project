...
public class SearchViewActivity extends BasicActivity
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                .listener(SearchViewActivity.this)
                .key("AIzaSyC9yp37nr_l8_QAKMPIxstkPtWbOPKCULg")
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( SearchViewActivity.this, REQUIRED_PERMISSIONS,
